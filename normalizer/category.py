...
_CATEGORIES_DIR = settings.DATA_DIR / "categories"
...
def load_category_assigner(market, source_type, category_slug=None):
    """Load a CategoryAssigner from rules/market/{market}/ directory."""
    from normalizer.rules import RuleLoader
    loader = RuleLoader(category_slug=category_slug, market=market)
