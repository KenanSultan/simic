...
from normalizer.images import download_product_image
from normalizer.category import (
    load_canonical_categories,
    load_category_assigner,
    get_subcategory_ids,
)
from normalizer.rules import RuleLoader
from normalizer.extractors.wolt import WoltExtractor
from normalizer.extractors.araz_website import ArazWebsiteExtractor
from normalizer.extractors.neptun_website import NeptunWebsiteExtractor
from normalizer.extractors.bazarstore_website import BazarstoreWebsiteExtractor
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Load category assigner (market + category specific)
        assigner = load_category_assigner(market, source_type, category_slug)
